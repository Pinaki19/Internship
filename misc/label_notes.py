...
def vader_sentiment():
    ...
    df['vader_sentiment'] = df['polarity'].apply(label)
    df=df[['note_text','trial_outcome','vader_sentiment']]
    df.to_csv('nltk_normal_labeled_notes.csv', index=False)
...
def textblob_sentiment():
    ...
    df['textblob_sentiment'] = df['polarity'].apply(label)
    df=df[['note_text','trial_outcome','textblob_sentiment']]
    df.to_csv('textblob_normal_labeled_notes.csv', index=False)
